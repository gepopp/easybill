...
class NewBilModalForm extends Component
{
    public $billing_date;
    public $prefix;
    public $bill_number;
    ...
    public function mount(){
        ...
        $this->respite = BillSetting::where('setting_name', 'desired_respite')->value('setting_value') ?? 7;
        $this->prefix = BillSetting::where('setting_name', 'prefix')->value('setting_value');
    ...
    {
        return view('livewire.new-bil-modal-form');
    }
}
