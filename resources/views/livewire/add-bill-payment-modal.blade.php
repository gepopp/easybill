            ...
            <form wire:submit.prevent="createPayment">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div>
                        ...
                        >
                        @error('payment_date')<p class="text-sm leading-none text-red-800 px-3 py-2 w-64">{{ $message }}</p>@enderror
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div>
                    <p>Offener Betrag: <span wire:click="resetAmount" class="cursor-pointer underline text-logo-primary text-sm">{{ $to_pay }}</span></p>
                    <div class="relative">
                        <input type="number"
                               step="0.01"
                               step="1"
                        ...
                        @error('amount')<p class="text-sm leading-none text-red-800 px-3 py-2 w-64">{{ $message }}</p>@enderror
                    </div>
                </div>
