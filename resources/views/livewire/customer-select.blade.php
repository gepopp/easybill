<div>
    <div class="relative" x-data="{ highlight : 0, search_results : {{ $search_result_json }} }">
        <input type="search"
               id="customer_name"
               class="w-64 appearance-none border-logo-primary border p-1 px-3 bg-logo-gray text-gray-600 text-left focus:outline-none"
        ...
        <div class="absolute top-0 left-0 mt-16 p-5 shadow-lg bg-white w-full z-50" x-show="search_results.length > 0">
            <ul>
