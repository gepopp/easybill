<div class="min-h-screen bg-logo-darker shadow-xl"
    ...
    >
        <x-jet-nav-link href="{{ route('quotation.index') }}" :active="request()->routeIs('quotation.*')" class="text-logo-gray mb-5">
            {{ __('Angebote') }}
        </x-jet-nav-link>
        ...
        <x-jet-nav-link href="{{ route('lead.index') }}" :active="request()->routeIs('lead.*')" class="text-logo-gray mb-5">
            {{ __('Lead') }}
        </x-jet-nav-link>
    </div>
